...
export default class Tealium {
    ...
    static initialize(config, callback) {
        ...
        TealiumWrapper.addToDataLayer({'plugin_name': 'Tealium-ReactNative', 'plugin_version': '2.4.1'}, Expiry.forever);
    ...
    static gatherTrackData(callback) {
        TealiumWrapper.gatherTrackData(callback);
    }
